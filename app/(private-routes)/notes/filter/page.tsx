...
export const metadata: Metadata = {
  ...
  description:
    'Browse and manage all your notes in one place. Filter by tags, search, and organize your personal notes efficiently.',
  keywords:
    'notes list, all notes, browse notes, manage notes, filter notes, search notes',
  openGraph: {
    title: 'All Notes | NoteHub',
